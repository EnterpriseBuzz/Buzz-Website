...
const BrandSwiper = memo(
  ({ slides, delay, spaceBetween = 20, className = "mySwiper" }) => {
...
function CompanySlide() {
  ...
  const slideData = useMemo(() => {
    const firstRowSlides = [
      {
        src: "../brands/Company logo-1.png",
        alt: "Company logo 1",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/Company logo-2.png",
        alt: "Company logo 2",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/Company logo-3.png",
        alt: "Company logo 3",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/Company logo-4.png",
        alt: "Company logo 4",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/Company logo-5.png",
        alt: "Company logo 5",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/Company logo-6.png",
        alt: "Company logo 6",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/Company logo-7.png",
        alt: "Company logo 7",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/SCompany logo.png",
    ...
    const secondRowSlides = [
      {
        src: "../brands/cobai.png",
        alt: "Cobai logo",
        className: "h-11 w-auto",
      },
      {
        src: "../brands/tefzon.png",
        alt: "Tefzon logo",
        className: "h-11 w-auto",
      },
      ...
      {
        src: "../brands/sunswitch.png",
        alt: "Sunswitch logo",
        className: "h-6 w-auto",
      },
      {
        src: "../brands/CloudClinic.png",
        alt: "CloudClinic logo",
        className: "h-7 w-auto",
      },
      {
        src: "../brands/airtimeflip.png",
        alt: "Airtimeflip logo",
        className: "h-6 w-auto",
      },
    ];

    return { firstRowSlides, secondRowSlides };
  }, []);
  ...
  return (
    <div
      ...
      role="region"
      aria-label="Client companies showcase"
    >
      <BrandSwiper
