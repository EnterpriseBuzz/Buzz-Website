  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        ...
        {/* Mobile view */}
        <div className="md:hidden py-10 px-2 flex flex-col justify-center">
          <motion.div
            initial={{ x: 20, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.5 }}
          ...
          <motion.div
            ...
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.5 }}
            className="w-full  transition transform pt-20"
          >
            <img src="./butt.svg" alt="pics" />
          </motion.div>
          <motion.button
            initial={{ x: 20, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
