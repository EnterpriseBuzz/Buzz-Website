        ...
        <div className="mx-auto sm:px-12 lg:px-24 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 mt-12">
          ...
          <div>
            ...
            <div className="bg-[#F4F4F4] px-8 md:px-12 py-6 rounded-b-xl space-y-3 ">
              <div className="flex items-center gap-x-2">
                ...
                <p className="text-[#36474F] text-center text-sm 2xl:text-base 3xl:text-lg ">
                  AI-Driven Campaigns
                </p>
              </div>
              <div className="flex items-center gap-x-2">
          ...
          <div>
            ...
            <div className="bg-[#F4F4F4] px-8 md:px-12 py-6 rounded-b-xl space-y-3">
              ...
              <div className="flex items-center gap-x-2">
                <img src="../check.svg" alt="check" />
                <p className="text-[#36474F] text-left text-sm 2xl:text-base 3xl:text-lg ">
          ...
          <div className=" lg:w-full mx-auto overflow-x-auto scrollbar-hide inset-x-0 lg:grid grid-cols-4  lg:mt-12 px-2 lg:px-0">
            ...
            <div className="">
              ...
              <div className="pt-3 2xl:pt-0 space-y-5 lg:space-y-10 2xl:space-y-11 3xl:space-y-12 lg:w-full">
                <p className="text-sm 2xl:text-base 3xl:text-lg ">AI-Driven Campaigns</p>
                ...
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Landing Page & CRO</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Landing Page & CRO</p>
                <div className="lg:py-[0.0px]"></div>
              </div>

              <p className="text-sm 2xl:text-base 3xl:text-lg font-bold">
                SEO and SEM Services
              </p>
              <div className="py-3 2xl:pb-3 2xl:pt-1 space-y-5 lg:space-y-10 2xl:space-y-12 lg:w-full">
                ...
                <p className="text-sm 2xl:text-base 3xl:text-lg ">3. Link Building</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Video Marketing</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">
                  Social Media Mgt. and Marketing
                </p>
              ...
              <div className="py-3 space-y-5 lg:space-y-10  lg:w-full">
                <p className="text-sm 2xl:text-base 3xl:text-lg ">1. Web Optimization</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">
                ...
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Blog Content Production</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">
                  Digital Display and Native Advertising
                </p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Influencer Outreach</p>
              ...
              <div className="py-6 2xl:py-1 space-y-5 lg:space-y-9  2xl:space-y-11 lg:w-full">
                ...
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Paid Search (SEM/PPC)</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">UGC Campaigns</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">
                  Immersive AR/VR Brand Experience Lab
                </p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">
                ...
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Performance Analytics</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">
                  Dedicated Account Management & Consulting
                </p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Sustainability Reporting</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">Performance Guarantees</p>
                <p className="text-sm 2xl:text-base 3xl:text-lg ">
